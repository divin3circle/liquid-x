...
export function CommunityICP() {
  return (
    <Card>
      ...
      <CardDescription>
        The Internet Computer Protocol (ICP) is a blockchain based on threshold
        cryptography, state machine replication, and a novel consensus
        algorithm.
      </CardDescription>
    </Card>
  );
    ...
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
        ...
        <Container className="circle-3">
          <Image src={icp} width={50} height={50} alt="polygon" />
        </Container>
