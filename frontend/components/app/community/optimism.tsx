...
export function CommunityOptimism() {
  return (
    <Card>
      <CardSkeletonContainer>
        <Skeleton />
      </CardSkeletonContainer>
      <CardTitle>Optimism</CardTitle>
      <CardDescription>
        Optimism is a Layer-2 scaling network for Ethereum that operates under a
        four-pillar design philosophy of simplicity, pragmatism, sustainability,
        and optimism.
      </CardDescription>
    </Card>
  );
    ...
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
        <Container className="h-8 w-8 circle-1">
          <Image src={icp} width={30} height={30} alt="polygon" />
        </Container>
        <Container className="h-12 w-12 circle-2">
          <Image src={eth} width={30} height={30} alt="polygon" />
        </Container>
        <Container className="circle-3">
          <Image src={optimism} width={50} height={50} alt="polygon" />
        </Container>
        <Container className="h-12 w-12 circle-4">
          <Image src={polygon} width={30} height={30} alt="polygon" />
        </Container>
        <Container className="h-8 w-8 circle-5">
          <Image src={avalanche} width={30} height={30} alt="polygon" />
        </Container>
      </div>
