...
export function CommunityAvalanche() {
  return (
    <Card>
      ...
      <CardDescription>
        Avalanche is a blockchain platform that aims to ensure scalability,
        security, and decentralization through a unique Proof of Stake (PoS)
        mechanism.
      </CardDescription>
    </Card>
  );
