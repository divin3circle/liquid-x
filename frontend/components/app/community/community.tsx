...
export function Community() {
  return (
    <Card>
      ...
      <CardDescription>
        Polygon (formerly Matic Network) is a blockchain platform which aims to
        create a multi-chain blockchain system compatible with Ethereum.
      </CardDescription>
    </Card>
  );
}
    ...
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center ">
      <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
        <Container className="h-8 w-8 circle-1">
          <Image src={optimism} width={30} height={30} alt="polygon" />
        </Container>
        <Container className="h-12 w-12 circle-2">
          <Image src={eth} width={30} height={30} alt="polygon" />
        </Container>
        <Container className="circle-3">
          <Image src={polygon} width={50} height={50} alt="polygon" />
        </Container>
