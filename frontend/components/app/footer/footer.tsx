      ...
      <footer className="">
        <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
          <div className="text-center">
            <h2 className="text-3xl font-extrabold text-gray-900 sm:text-5xl dark:text-text-100">
              Explore LiquidX Today
            </h2>

            <p className="mx-auto mt-4 max-w-sm text-gray-500 dark:text-gray-100">
            ...
            <a
              href="#"
              className="mt-8 inline-block rounded-full border border-primary-600 px-12 py-3 text-sm font-medium text-primary-600 hover:bg-indigo-600 hover:text-white ease-in transition-all duration-150 dark:text-text-100"
            >
              Start Defragmenting
            </a>
          </div>

          <div className="mt-16 border-t border-gray-100 pt-8 sm:flex sm:items-center sm:justify-between lg:mt-24 dark:border-gray-500">
