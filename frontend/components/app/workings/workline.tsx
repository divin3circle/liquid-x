...
export function WorkLine() {
  const data = [
    ...
    {
      title: "Borrow & Lend seamlessly across chains",
      content: (
        <div>
          <p
            className={`text-neutral-800 md:text-sm text-base font-normal mb-8 leading-relaxed md:w-3/4 ${titillium.className}`}
    ...
    {
      title: "Experience accurate credit scoring & risk assessment",
      content: (
        <div>
          <p
            className={`text-neutral-800 md:text-sm text-base font-normal mb-8 leading-relaxed md:w-3/4 ${titillium.className}`}
          >
            ...
            and more. This system provides a more accurate assessment of
            borrower risk, potentially lowering collateral requirements and
            making DeFi lending more accessible and efficient for all users.
          </p>
