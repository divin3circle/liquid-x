...
contract TokenConfig is Script, Parameters {
    ...
    function getAvalancheFujiToken() public pure returns (Token memory token) {
        token.wbtc = BaseToken(
            CHAIN_SELECTOR_AVALANCHE_FUJI,
            AVALANCHE_FUJI_WBTC,
            BTC_PRICE_FEED
        );
        token.weth = BaseToken(
            CHAIN_SELECTOR_AVALANCHE_FUJI,
            AVALANCHE_FUJI_WETH,
            ETH_PRICE_FEED
        );
        token.link = BaseToken(
            CHAIN_SELECTOR_AVALANCHE_FUJI,
            AVALANCHE_FUJI_LINK,
            LINK_PRICE_FEED
        );
    ...
    function getEthereumSepoliaToken()
        public
        pure
        returns (Token memory token)
    {
        ...
        token.weth = BaseToken(
            CHAIN_SELECTOR_ETHEREUM_SEPOLIA,
            ETHEREUM_SEPOLIA_WETH,
            ETH_PRICE_FEED
        );
        token.link = BaseToken(
            CHAIN_SELECTOR_ETHEREUM_SEPOLIA,
            ETHEREUM_SEPOLIA_LINK,
            LINK_PRICE_FEED
        );
        token.avax = BaseToken(
            CHAIN_SELECTOR_ETHEREUM_SEPOLIA,
    ...
    function getArbitrumSepoliaToken()
        public
        pure
        returns (Token memory token)
    {
    ...
    function getOptimismSepoliaToken()
        public
        pure
        returns (Token memory token)
    {
        token.wbtc = BaseToken(
            ...
            OPTIMISM_SEPOLIA_WBTC,
            BTC_PRICE_FEED
        );
        token.weth = BaseToken(
            CHAIN_SELECTOR_OPTIMISM_SEPOLIA,
            OPTIMISM_SEPOLIA_WETH,
            ETH_PRICE_FEED
        );
        token.link = BaseToken(
            CHAIN_SELECTOR_OPTIMISM_SEPOLIA,
            OPTIMISM_SEPOLIA_LINK,
            LINK_PRICE_FEED
        );
        token.avax = BaseToken(
            CHAIN_SELECTOR_OPTIMISM_SEPOLIA,
